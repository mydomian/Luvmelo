    ...
    <div class="position-sticky">
      ...
      <div class="display-flex-center-content">
        ...
        <button class=" navbar-toggler btn-nav-toggoler-hide-sidebar" type="button" onclick="toggleSidebar()">
          ...
          <a href="{{ route('admin-employees.index') }}" class="link-text-color-nav">
            <div style="display: flex; flex-direction: column; align-items: center; justify-content: center;">
          ...
          <a href="{{ route('admin-clients.index') }}" class="link-text-color-nav ">
            <div style="display: flex; flex-direction: column; align-items: center; justify-content: center;">
          ...
          <a href="{{ route('admin-distances.index') }}" class="link-text-color-nav">
            <div style="display: flex; flex-direction: column; align-items: center; justify-content: center;">
          ...
          <a href="{{ route('admin-calanders.index') }}" class="link-text-color-nav">
            <div style="display: flex; flex-direction: column; align-items: center; justify-content: center;">
          ...
          <a href="{{ route('admin-messages.index') }}" class="link-text-color-nav">
            <div style="display: flex; flex-direction: column; align-items: center; justify-content: center;">
